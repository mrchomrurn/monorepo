...
import AutoFormFieldTime from './AutoFormFieldTime.vue'
import AutoFormFieldMultipleSelect from './AutoFormFieldMultipleSelect.vue'
...
export const INPUT_COMPONENTS = {
  ...
  multipleSelect: AutoFormFieldMultipleSelect,
  time: AutoFormFieldTime,
}
